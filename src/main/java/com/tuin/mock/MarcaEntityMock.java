...
public class MarcaEntityMock {
	 ...
	 * @return
	 */
	public MarcaEntity createInstance() {
		// Primary Key values
	 ...
	 * @return
	 */
	public MarcaEntity createInstance( Long id ) {
	 ...
	 * @return
	 */
	public List<MarcaEntity> createList(int count) {
		List<MarcaEntity> list = new LinkedList<MarcaEntity>();		
