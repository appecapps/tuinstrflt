...
/**
 * JPA implementation for basic persistence operations ( entity "Chofer" )
 * 
 * @author Telosys Tools Generator
 *
 */
public class ChoferPersistenceJPA extends GenericJpaService<ChoferEntity, Long> implements ChoferPersistence {

	/**
	 * Constructor
	 */
	public ChoferPersistenceJPA() {
	...
	public long countAll() {
		...
		JpaOperation operation = new JpaOperation() {
			...
			public Object exectue(EntityManager em) throws PersistenceException {
				Query query = em.createNamedQuery("ChoferEntity.countAll");
