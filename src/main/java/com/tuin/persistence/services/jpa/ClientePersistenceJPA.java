...
/**
 * JPA implementation for basic persistence operations ( entity "Cliente" )
 * 
 * @author Telosys Tools Generator
 *
 */
public class ClientePersistenceJPA extends GenericJpaService<ClienteEntity, Long> implements ClientePersistence {

	/**
	 * Constructor
	 */
	public ClientePersistenceJPA() {
	...
	public long countAll() {
		...
		JpaOperation operation = new JpaOperation() {
			...
			public Object exectue(EntityManager em) throws PersistenceException {
				Query query = em.createNamedQuery("ClienteEntity.countAll");
