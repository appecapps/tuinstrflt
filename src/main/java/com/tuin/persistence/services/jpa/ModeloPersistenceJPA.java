...
/**
 * JPA implementation for basic persistence operations ( entity "Modelo" )
 * 
 * @author Telosys Tools Generator
 *
 */
public class ModeloPersistenceJPA extends GenericJpaService<ModeloEntity, Long> implements ModeloPersistence {

	/**
	 * Constructor
	 */
	public ModeloPersistenceJPA() {
	...
	public long countAll() {
		...
		JpaOperation operation = new JpaOperation() {
			...
			public Object exectue(EntityManager em) throws PersistenceException {
				Query query = em.createNamedQuery("ModeloEntity.countAll");
