...
/**
 * JPA implementation for basic persistence operations ( entity "Vehiculoservicio" )
 * 
 * @author Telosys Tools Generator
 *
 */
public class VehiculoservicioPersistenceJPA extends GenericJpaService<VehiculoservicioEntity, Long> implements VehiculoservicioPersistence {

	/**
	 * Constructor
	 */
	public VehiculoservicioPersistenceJPA() {
	...
	public long countAll() {
		...
		JpaOperation operation = new JpaOperation() {
			...
			public Object exectue(EntityManager em) throws PersistenceException {
				Query query = em.createNamedQuery("VehiculoservicioEntity.countAll");
