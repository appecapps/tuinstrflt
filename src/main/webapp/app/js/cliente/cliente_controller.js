 ...
 **/
clienteModule.controller('ClienteCtrl', ['Cliente',  'Entidad', '$scope', '$routeParams', '$http', '$location', '$cookies', 'MessageHandler', 'restURL', function(Cliente, Entidad, $scope, $routeParams, $http, $location, $cookies, MessageHandler, restURL) {
