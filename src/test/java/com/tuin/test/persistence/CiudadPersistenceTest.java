...
import com.tuin.mock.CiudadEntityMock;
...
/**
 * JUnit test case for Ciudad persistence service
 * 
...
public class CiudadPersistenceTest 
{
	...
	public void test1() {
		...
		CiudadPersistence service = PersistenceServiceProvider.getService(CiudadPersistence.class);
	...
	public void test2() {
		...
		System.out.println("Test Ciudad persistence : delete + load ..." );
		
		CiudadPersistence service = PersistenceServiceProvider.getService(CiudadPersistence.class);
		
		CiudadEntityMock mock = new CiudadEntityMock();
	...
	private void process(CiudadPersistence service, CiudadEntityMock mock, Long id ) {
		System.out.println("----- "  );
		System.out.println(" . load : " );
		CiudadEntity entity = service.load( id );
		if ( entity != null ) {
			// Found 
