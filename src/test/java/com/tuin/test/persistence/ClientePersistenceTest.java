...
import com.tuin.mock.ClienteEntityMock;
...
/**
 * JUnit test case for Cliente persistence service
 * 
...
public class ClientePersistenceTest 
{
	...
	public void test1() {
		...
		ClientePersistence service = PersistenceServiceProvider.getService(ClientePersistence.class);
	...
	public void test2() {
		...
		System.out.println("Test Cliente persistence : delete + load ..." );
		
		ClientePersistence service = PersistenceServiceProvider.getService(ClientePersistence.class);
		
		ClienteEntityMock mock = new ClienteEntityMock();
	...
	private void process(ClientePersistence service, ClienteEntityMock mock, Long id ) {
		System.out.println("----- "  );
		System.out.println(" . load : " );
		ClienteEntity entity = service.load( id );
		if ( entity != null ) {
			// Found 
