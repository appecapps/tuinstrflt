...
import com.tuin.mock.EstadoEntityMock;
...
/**
 * JUnit test case for Estado persistence service
 * 
...
public class EstadoPersistenceTest 
{
	...
	public void test1() {
		...
		EstadoPersistence service = PersistenceServiceProvider.getService(EstadoPersistence.class);
	...
	public void test2() {
		...
		System.out.println("Test Estado persistence : delete + load ..." );
		
		EstadoPersistence service = PersistenceServiceProvider.getService(EstadoPersistence.class);
		
		EstadoEntityMock mock = new EstadoEntityMock();
	...
	private void process(EstadoPersistence service, EstadoEntityMock mock, Long id ) {
		System.out.println("----- "  );
		System.out.println(" . load : " );
		EstadoEntity entity = service.load( id );
		if ( entity != null ) {
			// Found 
