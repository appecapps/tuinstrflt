...
import com.tuin.mock.FormapagoEntityMock;
...
/**
 * JUnit test case for Formapago persistence service
 * 
...
public class FormapagoPersistenceTest 
{
	...
	public void test1() {
		...
		FormapagoPersistence service = PersistenceServiceProvider.getService(FormapagoPersistence.class);
	...
	public void test2() {
		...
		System.out.println("Test Formapago persistence : delete + load ..." );
		
		FormapagoPersistence service = PersistenceServiceProvider.getService(FormapagoPersistence.class);
		
		FormapagoEntityMock mock = new FormapagoEntityMock();
	...
	private void process(FormapagoPersistence service, FormapagoEntityMock mock, Long id ) {
		System.out.println("----- "  );
		System.out.println(" . load : " );
		FormapagoEntity entity = service.load( id );
		if ( entity != null ) {
			// Found 
