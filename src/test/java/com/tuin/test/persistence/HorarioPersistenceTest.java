...
import com.tuin.mock.HorarioEntityMock;
...
/**
 * JUnit test case for Horario persistence service
 * 
...
public class HorarioPersistenceTest 
{
	...
	public void test1() {
		...
		HorarioPersistence service = PersistenceServiceProvider.getService(HorarioPersistence.class);
	...
	public void test2() {
		...
		System.out.println("Test Horario persistence : delete + load ..." );
		
		HorarioPersistence service = PersistenceServiceProvider.getService(HorarioPersistence.class);
		
		HorarioEntityMock mock = new HorarioEntityMock();
	...
	private void process(HorarioPersistence service, HorarioEntityMock mock, Long id ) {
		System.out.println("----- "  );
		System.out.println(" . load : " );
		HorarioEntity entity = service.load( id );
		if ( entity != null ) {
			// Found 
