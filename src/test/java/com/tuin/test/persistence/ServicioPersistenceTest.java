...
import com.tuin.mock.ServicioEntityMock;
...
/**
 * JUnit test case for Servicio persistence service
 * 
...
public class ServicioPersistenceTest 
{
	...
	public void test1() {
		...
		ServicioPersistence service = PersistenceServiceProvider.getService(ServicioPersistence.class);
	...
	public void test2() {
		...
		System.out.println("Test Servicio persistence : delete + load ..." );
		
		ServicioPersistence service = PersistenceServiceProvider.getService(ServicioPersistence.class);
		
		ServicioEntityMock mock = new ServicioEntityMock();
	...
	private void process(ServicioPersistence service, ServicioEntityMock mock, Long id ) {
		System.out.println("----- "  );
		System.out.println(" . load : " );
		ServicioEntity entity = service.load( id );
		if ( entity != null ) {
			// Found 
